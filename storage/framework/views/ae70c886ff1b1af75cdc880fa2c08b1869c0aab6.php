<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Gestión de Campos Profesionales de la Metodología IPP-R</h3>
              <a style="float: right;" type="button" class="btn btn-default" href="<?php echo e(URL::to('inventarioInteresesProfesionales')); ?>"><i class="fa fa-reply-all" aria-hidden="true"></i> 
          Volver</a>
            </div>
        ...
        <div class="box box-success" v-if="divNuevoCampoProf">
            <div class="box-header with-border" >
              <h3 class="box-title" id="tituloAgregar">Nuevo Campo Profesional</h3>
            </div>
            ...
            <form v-on:submit.prevent="createCampoProf">
             <div class="box-body">
             	...
             	<div class="form-group">
                  <label for="txtNombre" class="col-sm-2 control-label">Nombre del Campo:*</label>
        ...
        <div class="sk-circle12 sk-child"></div>
          ...
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Listado de Campos Académicas</h3>
            ...
            <div class="box-body table-responsive">
              <table class="table table-hover table-bordered" >
                <tbody><tr>
                  ...
                  <th style="padding: 5px; width: 50%;">Campo Profesional</th>
                ...
                <tr v-for="campoprofesional, key in campoprofesionals">
                  ...
                  <td style="font-size: 12px; padding: 5px;">
                    ...
                    <a v-bind:href="'/maestrocarreras/' + campoprofesional.id" class="btn btn-success btn-sm"><i class="fa fa-book" aria-hidden="true" data-placement="top" data-toggle="tooltip" title=" Gestión de Carreras Profesionales"></i></a>

                  	<a href="#" v-if="campoprofesional.activo=='1'" class="btn bg-navy btn-sm" v-on:click.prevent="bajaCampoProf(campoprofesional)" data-placement="top" data-toggle="tooltip" title="Desactivar Campo Profesional"><i class="fa fa-arrow-circle-down"></i></a>

                  	<a href="#" v-if="campoprofesional.activo=='0'" class="btn btn-success btn-sm" v-on:click.prevent="altaCampoProf(campoprofesional)" data-placement="top" data-toggle="tooltip" title="Activar Campo Profesional"><i class="fa fa-check-circle"></i></a>


                  	<a href="#" class="btn btn-warning btn-sm" v-on:click.prevent="editCampoProf(campoprofesional)" data-placement="top" data-toggle="tooltip" title="Editar Campo Profesional"><i class="fa fa-edit"></i></a>
                  	<a href="#" class="btn btn-danger btn-sm" v-on:click.prevent="borrarCampoProf(campoprofesional)" data-placement="top" data-toggle="tooltip" title="Borrar Campo Profesional"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
    ...
    <div class="modal-content">
      ...
      <div class="box" id="o" style="border:0px; box-shadow:none;" >
            ...
            <!-- form start -->
              ...
              <div class="form-group">
                  <label for="txtNombreE" class="col-sm-2 control-label">Nombre del Campo:*</label>
