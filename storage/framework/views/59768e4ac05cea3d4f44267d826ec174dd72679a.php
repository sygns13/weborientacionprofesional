            ...
            <div class="col-md-12" style="padding-top: 15px;">
                ...
                <div class="form-group">
                  <label for="archivo" class="col-md-1 control-label">Imagen de Perfil: (Opcional)</label>
                    <div class="col-md-11">
                     <img v-if="fillPersona.genero==1" src="<?php echo e(asset('/img/av3.png')); ?>" class="img-responsive" style="width: 130px; border: 2px solid black;" id="ImgPerfilNuevoE">

                     <img v-if="fillPersona.genero==0" src="<?php echo e(asset('/img/av2.jpg')); ?>" class="img-responsive" style="width: 130px; border: 2px solid black;" id="ImgPerfilNuevoE">
                   </div>
