<div class="box box-primary">
            <div class="box-header with-border">
              ...
              <a style="float: right;" type="button" class="btn btn-default" href="<?php echo e(URL::to('kuder')); ?>"><i class="fa fa-reply-all" aria-hidden="true"></i> 
          Volver</a>
            </div>
...
<?php echo $__env->make('preguntaskuder.alternativas', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
