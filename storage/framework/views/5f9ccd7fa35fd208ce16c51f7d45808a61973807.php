    ...
    <template v-for="regla, key2 in reglas" >
      <template v-if="modulo.id==regla.modulovocacional_id" >
          ...
          <tr>
              ...
              <div class="form-group">
            <a v-bind:href="'preguntaskuder/' + modulo.id" class="btn btn-success btn-sm"><i class="fa fa-plus-square-o" aria-hidden="true" ></i> Gestionar Preguntas</a>
            </div>
...
<?php echo $__env->make('kuder.reglas', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
