...
<header class="main-header">
    ...
    <a href="<?php echo e(url('/home')); ?>" class="logo">
        ...
        <span class="logo-mini"><b>S</b>OV</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Orientación</b> Voc.</span>
    </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu" id="menuBajar1">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="<?php echo e(url('/settings')); ?>" class="btn btn-default btn-flat" style="display: none;"><?php echo e(trans('adminlte_lang::message.profile')); ?></a>
                                </div>
