    ...
    <div id="headerwrap">
        <div class="container">
            <div class="row centered">
                <div class="col-lg-12">
                    <center><img class="img-responsive" src="<?php echo e(asset('/img/logo.png')); ?>"></center>
                    ...
                    <h3><a href="<?php echo e(url('/login')); ?>" class="btn btn-lg btn-success">Iniciar Sesión</a></h3>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-8">
                    <img class="img-responsive" src="<?php echo e(asset('/img/imgov1.jpg')); ?>" alt="">
                </div>
                <div class="col-lg-2">
                    <br>
...
<?php /**PATH D:\Proyectos\tesis\weborientacionprofesional\resources\views/vendor/adminlte/layouts/landing.blade.php ENDPATH**/ ?>