...
<div class="col-lg-12 col-xs-12">
		...
		<div class="col-lg-3 col-xs-6" >
          <div class="small-box bg-green">
            ...
            <a href="<?php echo e(URL::to('areasUNASAM')); ?>" class="small-box-footer" style="height: 37px; font-size: 25px;">Ingresar 
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-aqua">
            ...
            <a href="<?php echo e(URL::to('ciclos')); ?>" class="small-box-footer" style="height: 37px; font-size: 25px;">Ingresar 
            <i style="font-size: 30px; " class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?php echo e(URL::to('facultades')); ?>" class="small-box-footer" style="height: 37px; font-size: 25px;">Ingresar 
            <i style="font-size: 30px; " class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="<?php echo e(URL::to('carrerasUNASAM')); ?>" class="small-box-footer" style="height: 37px; font-size: 25px;">Ingresar 
            <i style="font-size: 30px; " class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
...
<?php if(accesoUser([1,3])): ?>
		...
		<div class="col-lg-3 col-xs-6" >
          ...
          <div class="small-box bg-red">
            ...
            <a href="<?php echo e(URL::to('inventarioInteresesProfesionales')); ?>" class="small-box-footer" style="height: 37px; font-size: 25px;">Ingresar 
            <i style="font-size: 30px; " class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6" >
          ...
          <div class="small-box bg-yellow">
            ...
            <a href="<?php echo e(URL::to('kuder')); ?>" class="small-box-footer" style="height: 37px; font-size: 25px;">Ingresar 
            <i style="font-size: 30px; " class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6" >
          ...
          <div class="small-box bg-blue">
            ...
            <a href="<?php echo e(URL::to('reportes')); ?>" class="small-box-footer" style="height: 37px; font-size: 25px;">Ingresar 
            <i style="font-size: 30px; " class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
