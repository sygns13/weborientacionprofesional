<?php $__env->startSection('htmlheader_title'); ?>
	Imprimir Plantilla de Corrección
...
<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Metodología <?php echo e($nombreMet); ?> <br><br>
              <?php echo e($tituloMod); ?>: Gestión de Preguntas del Módulo</h3>
              <a style="float: right;" type="button" class="btn btn-default" href="<?php echo e(URL::to('preguntasippr/'.$idModulo)); ?>"><i class="fa fa-reply-all" aria-hidden="true"></i> 
          Volver</a>
            </div>
...
<center>
 ...
 <div style="width: 21cm; height: 29cm; background-color: white;" id="divImp">
  <div style="padding-top: 1.5cm;padding-left: 1cm; padding-right: 0.7cm;">
    <center><b>IPP – PLANTILLA DE CORRECCIÓN</b></center>
...
<div style="padding-top: 0.4cm;">
      <table style="border: 1px solid gray; width: 19%; float: left;font-size: 10px;">
        ...
        <tr v-if="pregunta.campoprofesional_id==campoprofesional.id" >
          ...
          <td v-bind:rowspan="array[campoprofesional.orden-1]" style="padding:3px;width: 14.8%;border:1px solid gray; text-align: center;" ><b>{{ campoprofesional.orden }}</b></td>
          </template>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;" v-if="pregunta.detactividadprofesion=='1'"><b>A</b></td>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;" v-if="pregunta.detactividadprofesion=='2'"><b>Pr</b></td>
      ...
      <table style="border: 1px solid gray; width: 19%; float: left;font-size: 10px; margin-left: 9px;">
        ...
        <tr v-if="pregunta.campoprofesional_id==campoprofesional.id" >
           <template v-if="pregunta.activo=='1'">
          <td v-bind:rowspan="array[campoprofesional.orden+16]" style="padding:3px;width: 14.8%;border:1px solid gray; text-align: center;" ><b>{{ campoprofesional.orden }}</b></td>
          </template>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;" v-if="pregunta.detactividadprofesion=='1'"><b>A</b></td>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;" v-if="pregunta.detactividadprofesion=='2'"><b>Pr</b></td>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;"><b>{{ pregunta.orden }}</b></td>
      ...
      <table style="border: 1px solid gray; width: 19%; float: left;font-size: 10px; margin-left: 9px;">
        ...
        <tr v-if="pregunta.campoprofesional_id==campoprofesional.id" >
          <template v-if="pregunta.activo=='1'">
          <td v-bind:rowspan="array[campoprofesional.orden+33]" style="padding:3px;width: 14.8%;border:1px solid gray; text-align: center;" ><b>{{ campoprofesional.orden }}</b></td>
          </template>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;" v-if="pregunta.detactividadprofesion=='1'"><b>A</b></td>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;" v-if="pregunta.detactividadprofesion=='2'"><b>Pr</b></td>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;"><b>{{ pregunta.orden }}</b></td>
      ...
      <table style="border: 1px solid gray; width: 19%; float: left;font-size: 10px; margin-left: 9px;">
        ...
        <tr v-if="pregunta.campoprofesional_id==campoprofesional.id" >
          <template v-if="pregunta.activo=='1'">
          <td v-bind:rowspan="array[campoprofesional.orden+50]" style="padding:3px;width: 14.8%;border:1px solid gray; text-align: center;" ><b>{{ campoprofesional.orden }}</b></td>
          </template>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;" v-if="pregunta.detactividadprofesion=='1'"><b>A</b></td>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;" v-if="pregunta.detactividadprofesion=='2'"><b>Pr</b></td>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;"><b>{{ pregunta.orden }}</b></td>
       ...
       <table style="border: 1px solid gray; width: 19%; float: left;font-size: 10px; margin-left: 9px;">
        ...
        <tr v-if="pregunta.campoprofesional_id==campoprofesional.id" >
          <template v-if="pregunta.activo=='1'">
          <td v-bind:rowspan="array[campoprofesional.orden+67]" style="padding:3px;width: 14.8%;border:1px solid gray; text-align: center;" ><b>{{ campoprofesional.orden }}</b></td>
          </template>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;" v-if="pregunta.detactividadprofesion=='1'"><b>A</b></td>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;" v-if="pregunta.detactividadprofesion=='2'"><b>Pr</b></td>
          <td style="padding:3px;width: 14.6%;border:1px solid gray; text-align: center;"><b>{{ pregunta.orden }}</b></td>
