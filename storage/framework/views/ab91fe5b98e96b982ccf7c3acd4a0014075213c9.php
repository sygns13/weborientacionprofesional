        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview" v-bind:class="classMenu1">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo e(URL::to('areasUNASAM')); ?>">Áreas Académicas</a></li>
                    <li><a href="<?php echo e(URL::to('ciclos')); ?>">Ciclos Académicos</a></li>
                    <li><a href="<?php echo e(URL::to('facultades')); ?>">Facultades UNASAM</a></li>
                    <li><a href="<?php echo e(URL::to('carrerasUNASAM')); ?>">Carreras UNASAM</a></li>
                    <li><a href="<?php echo e(URL::to('alumnos')); ?>">Alumnos CPU</a></li>
                </ul>
            </li>
            <?php endif; ?>
            ...
            <li v-bind:class="classMenu2"><a href="<?php echo e(URL::to('usuarios')); ?>"><i class='fa fa-user-secret'></i> <span>Administrar Usuarios</span></a></li>
            ...
            <li class="treeview" v-bind:class="classMenu3">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo e(URL::to('inventarioInteresesProfesionales')); ?>">Metodología IPP-R</a></li>
                    <li><a href="<?php echo e(URL::to('kuder')); ?>">Metodología KUDER</a></li>
                </ul>
            </li>
            ...
            <li class="treeview" v-bind:class="classMenu5">
                <a href="#"><i class='fa fa-file-text-o'></i> <span>Iniciar Test</span> <i class="fa fa-angle-left pull-right"></i></a>
                    <ul class="treeview-menu">
                    <li><a href="<?php echo e(URL::to('testIPP')); ?>">Test IPP</a></li>
                    <li><a href="<?php echo e(URL::to('testKUDER')); ?>">Test KUDER</a></li>
                </ul>
            </li>
