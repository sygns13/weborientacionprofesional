<div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Metodología IPP-R<br><br>Gestión de Carreras profesionales del Campos Profesional {{ $nombreCampo }} </h3>
              <a style="float: right;" type="button" class="btn btn-default" href="{{URL::to('/campoprofesionalippr/'.$idMetodologia)}}"><i class="fa fa-reply-all" aria-hidden="true"></i> 
          Volver</a>
            </div>
        ...
        <div class="sk-circle12 sk-child"></div>
          ...
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Listado de Carreras Profesionales del Campos Profesional {{ $nombreCampo }}</h3>
