...
<a v-bind:href="'campoprofesionalkuder/' + metodologiaD.id" class="btn btn-success"><i class="fa fa-mortar-board" aria-hidden="true" ></i> Gestión de Áreas de Interés Profesional</a>
